...
<div class="modal fade" id="cadastrar_modal">
      <div class="modal-dialog modal-lm">
        ...
        <form method="post" action="AppControle?logica=nuser" role="form">
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                ...
                <div class="form-group">
                  ...
                  <%
                        out.print("<input name=\"email\" type=\"email\" class=\"form-control\" id=\"email\" placeholder=\"nome@email.com\" ");
                        if(usuario_criacao != null){
        ...
        <div class="modal-footer">
              <button type="submit" for="cadastrar" class="btn btn-success"><span class="glyphicon glyphicon-ok"></span> Cadastrar</button>
